...
namespace IAM.Areas.Identity.Pages.Account
{
    ...
    public class RegisterPlayerModel : PageModel
    {
        ...
        private readonly ILogger<RegisterPlayerModel> _logger;
        ...
        public async Task OnGetAsync(string returnUrl = null, [FromQuery] string username = null, int avatar = 1, string creyTicket = null)
        {
            ReturnUrl = returnUrl;
            Input = new UserInputModel { UserName = username, AvatarId = avatar };
