...
namespace Crey.Extensions
{
    public static class ValueTypeExtensions
    {
        ...
        public static bool IsValueInEnum<T>(this int value)
        {
            ...
            Debug.Assert(Enum.GetUnderlyingType(typeof(T)) == typeof(int), $"Invalid underlying type ({Enum.GetUnderlyingType(typeof(T)).FullName} != int)");
        ...
        public static string ToTransferred(this int value)
        {
            return ToTransferred((long)value);
        }

        public static string ToTransferred(this long value)
        {
            if (value < 50000)
            {
            ...
            if (value < 1024 * 1024)
            {
                return $"{Math.Round(value / 1024.0, 1)}Kb";
            }

            return $"{Math.Round(value / (1024.0 * 1024.0), 1)}Mb";
        }
        ...
        public static string ToEu(this DateTime date, bool useSeconds = false)
        {
            return useSeconds ? $"{date:yyyy.MM.dd HH:mm:ss}" : $"{date:yyyy.MM.dd HH:mm}";
        }

        public static string ToDayKey(this DateTime date)
        {
            return $"{date:yyyyMMdd}";
        }

        public static string ToUtcNowKey(this DateTime date)
        {
            return ToDayKey(DateTime.UtcNow);
        }
